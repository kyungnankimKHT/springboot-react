(function () {
  /*VERSION:221018*/ function checkWebviewCustomUA(a) {
    for (
      var b = ["daum", "naver", "google", "facebook", "twitter"],
        c = !1,
        d = 0,
        e = b.length;
      d < e;
  ...
  (window.daum = window.daum || {}),
    (function (a) {
      ...
      for (
        var d = document.getElementsByTagName("script"), e = 0, f = d.length;
        e < f;
        ++e
      ) {
        var g = d[e],
          h = g.src;
        if (
          /\/mapjsapi\/bundle\/postcode\/(prod){0,1}(dev){0,1}(cbt){0,1}\/postcode.v2\.js\b/.test(
            h
          )
        ) {
  ...
  (postcodeUtils.param = (function (a) {
    ...
    (postcodeUtils.isAvailable = function (a) {
      return (
        !postcodeUtils.isUndefined(a) &&
        !postcodeUtils.isNull(a) &&
        ...
        a &&
          ...
          this.on(a, "touchmove", function (a) {
            ...
            var b =
              ...
              l = Math.abs(j - e);
            (f >= k || l >= k) &&
              ((g = !0), d && "function" == typeof d && d(a));
          }),
          this.on(a, "touchend", function (a) {
            h.stopPropagation(a),
              f && !g
                ? ((f = !1), e && "function" == typeof e && e(a))
                : ((f = !1), (g = !1));
          }));
      },
    }),
    ...
    (a.CONT = {
      ...
      (a.viewUtils = (function () {
        function b(a, b, d, e, f, h) {
          "msie" !== g.browser.name ||
          7 !== parseInt(g.browser.version.major, 10) ||
          c.postMessage
            ? "msie" !== g.browser.name ||
              ...
              (a.document.getElementById(e).style.width =
                b.offsetWidth - 4 + "px"),
              (b.style.height = h + "px"),
              (d.style.height = h + "px"))
            : ((a.document.getElementById(e).style.height = h - 4 + "px"),
        ...
        function k(a, b) {
          b &&
            (a
              ? q.TARGET_MAP[b.id] === a &&
                (a.removeChild(b), (q.TARGET_MAP[b.id] = null))
        ...
        function l(a, b, c) {
          var d = "",
            ...
            f = a + c;
          return (
            f.length > e ? ((f = a + b), (d = f.length > e ? a : f)) : (d = f),
            d
          );
        }
        function m(a, b) {
        ...
        function b(a) {
          ...
          for (var d in a)
            a.hasOwnProperty(d) &&
              ...
              (c
                ? (b[d] = a[d])
                : (b[d] = isNaN(a[d]) ? a[d] : parseInt(a[d], 10)));
          return b;
        }
        function d(a, b) {
          var c = a + "_" + b,
    ...
    a.frame = (function () {
      ...
      function b() {
        ...
        return (
          ...
          a.setAttribute("title", "�고렪踰덊샇�쒕퉬�� �덉씠�� �꾨젅��"),
          (a.style.cssText = f.getStringByOptions(b, ":", ";")),
          a
        );
      }
      function e(c, d) {
        if (null === p) return alert("POPUP URL�� �뗮똿�� 二쇱꽭��.");
        var e = a(c),
          g = b();
        return (
      ...
      function n(a) {
        ...
        if (d)
          for (
            var e = c.getElementsByTagName("iframe"), f = 0, g = e.length;
            f < g;
            f++
          ) {
            var h = e[f].id || null;
        ...
        if (b.onClose !== g.EMPTY_FUNCTION) {
          ...
          c &&
            ...
            (c.data.closeCallbackTimer = setInterval(function () {
              ...
              d ||
                void 0 !== a.closed ||
                (d = void 0 === a.window || null === a.window),
                d &&
                  (clearInterval(c.data.closeCallbackTimer),
      ...
      var p = null,
        ...
        s = function (a) {
          ...
          var d = p + "&" + f.getStringByOptions(c, "=", "&"),
            ...
            i =
              '<iframe frameborder="0" title="�고렪踰덊샇 寃��� �꾨젅��" id="' +
  ...
  !(function (a, b, c, d, e) {
    var f = b,
      g =
        "msie" === f.userAgent.browser.name &&
        parseInt(f.userAgent.browser.version.major, 10) <= 6;
      ...
      if (
        ...
        isNaN(c.maxSuggestItems) || "number" != typeof c.maxSuggestItems
          ...
          : ((c.maxSuggestItems = parseInt(c.maxSuggestItems, 10)),
            (c.maxSuggestItems < 1 || c.maxSuggestItems > 10) &&
              (c.maxSuggestItems = 10)),
